...
<div class="container d-flex justify-content-center mt-5">
    <div class="glass-container w-100" style="max-width: 850px; padding: 2.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0 fw-bold" style="color: var(--primary-color);">Add New Student</h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 mb-2">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center gap-4 p-4 bg-white bg-opacity-50 rounded-4 border border-white shadow-sm">
                        <img id="imagePreview" src="#" alt="Preview" class="rounded-circle shadow d-none" style="width: 100px; height: 100px; object-fit: cover; object-position: center; border: 4px solid white;">
                ...
                <div class="col-12 text-end mt-2">
                    <button type="submit" class="btn btn-modern px-5 py-2">Create Student</button>
                </div>
            </div>
        </form>
    </div>
