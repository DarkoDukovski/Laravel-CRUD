...
<div class="container d-flex justify-content-center mt-5">
    <div class="glass-container w-100" style="max-width: 700px; padding: 2.5rem;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0 fw-bold" style="color: var(--primary-color);">Add News</h2>
        ...
        <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-4">
                ...
                <div class="col-12 mt-4">
                    <label class="form-label-modern"><i class="bi bi-image"></i> Cover Image (Optional)</label>
                    <div class="d-flex flex-column flex-md-row align-items-center gap-4 p-4 bg-white bg-opacity-50 rounded-4 border border-white shadow-sm">
                        <img id="imagePreview" src="#" alt="Preview" class="rounded-3 shadow d-none" style="height: 100px; width: 160px; object-fit: cover; object-position: center; border: 3px solid white;">
                ...
                <div class="col-12 text-end mt-4 pt-3 border-top border-light">
                    <button type="submit" class="btn btn-modern px-5 py-2">Create News</button>
                </div>
